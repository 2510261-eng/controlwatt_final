<?php $__env->startSection('title', 'Sistema Consumo · Control de energía eléctrica del hogar'); ?>
...
<section class="py-10">
    ...
    <div class="mt-6 flex flex-wrap gap-3">
        <a href="<?php echo e(route('register')); ?>" class="btn btn-amber">Crear cuenta</a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-ghost">Ya tengo cuenta</a>
    </div>
    ...
    <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="card">
            <h3 class="font-semibold text-emerald-300"><?php echo e($t); ?></h3>
            <p class="mt-2 text-sm text-slate-300"><?php echo e($d); ?></p>
        </article>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Omar\Desktop\control-watt.i\sistema-consumo-laravel-v3\sistema-consumo\resources\views/home.blade.php ENDPATH**/ ?>