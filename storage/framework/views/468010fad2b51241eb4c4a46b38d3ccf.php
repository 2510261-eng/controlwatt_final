<?php $__env->startSection('title', 'Compartir · Sistema Consumo'); ?>
...
<div class="mt-5 grid gap-5 lg:grid-cols-2">
    <form method="POST" action="<?php echo e(route('groups.store')); ?>" class="card space-y-3">
        <?php echo csrf_field(); ?>
    ...
    <form method="POST" action="<?php echo e(route('groups.join')); ?>" class="card space-y-3">
        <?php echo csrf_field(); ?>
    ...
    <div class="mt-3 overflow-x-auto">
        <table class="data">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="font-semibold"><?php echo e($group->name); ?></td>
                    <td><code class="rounded bg-slate-800 px-2 py-1 text-amber-300"><?php echo e($group->code); ?></code></td>
                    <td><?php echo e($group->members->pluck('name')->join(', ')); ?></td>
                    <td><?php echo e($group->devices_count); ?></td>
                    <td class="text-right">
                        <form method="POST" action="<?php echo e(route('groups.leave', $group)); ?>" onsubmit="return confirm('¿Salir de esta familia?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\gamec\Desktop\sistema-consumo-laravel-v3\sistema-consumo\resources\views/groups/index.blade.php ENDPATH**/ ?>